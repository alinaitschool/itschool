...
public class ChallengeTen {
    public static void main(String[] args) {
        // Declare and initialize variables a, b, c, and d
        int a = 10;
        int b = 20;
        int c = 30;
        int d = 40;

        // Calculate additionResult and multiplicationResult
        int additionResult = a + b;
        int multiplicationResult = c * d;

        // Print the results
        System.out.println("Addition result of a and b: " + additionResult);
        System.out.println("Multiplication result of c and d: " + multiplicationResult);
    }
}
